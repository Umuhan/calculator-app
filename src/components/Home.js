  ...
  <div>
    ...
    <div>
      <p style={{ textAlign: "left" }} className="lorem">
        ...
        error eveniet ullam sequi!
      </p>
      <p className="lorem">
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptas
        laudantium blanditiis non consequatur facere! Reiciendis, fuga
        consequatur officia quam expedita corrupti, aut assumenda et repellat
        explicabo nisi perferendis corporis iure!
      </p>
    </div>
  </div>
);
